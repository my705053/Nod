...
public class ADFUtils {
     ...
     * @return operation binding
     */
    public static OperationBinding findPageDefOperation(String pageDef,
                                                        String operation) {
        OperationBinding op =
            findBindingContainer(pageDef).getOperationBinding(operation);
        if (op == null) {
    ...
    public static void doPartialRefresh(UIComponent component) {
    ...
    public static Map getRequestScope(){
      return (Map)JSFUtils.resolveExpression("#{requestScope}");
    }
    ...
    public static void launchTaskFlowURL(TaskFlowId taskFlowId,Map<String, Object> taskFlowParams) throws Exception {
    ...
    public static void launchRedirectByViewId(String viewId) throws Exception{
        FacesContext fctx = FacesContext.getCurrentInstance();
        ExternalContext ectx = fctx.getExternalContext();            
    ...
    public static void displayRowContents(Row aRow) {
        String[] attributes = aRow.getAttributeNames();
        for (String attribute : attributes) {
            System.out.println("\t" + attribute + " = " + aRow.getAttribute(attribute));
        }
    }
}
